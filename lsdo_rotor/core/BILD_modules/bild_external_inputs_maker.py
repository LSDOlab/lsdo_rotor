...
class BILDExternalInputsModuleMaker(ModuleMaker):
    ...
    def define_module(self):
        ...
        rotor_radius = self.register_module_input(name='propeller_radius', shape=(num_nodes,), units='m')
        ...
        V = self.register_module_output('velocity_vector', shape=(num_nodes,3), units='m/s')
