...
class BEMAirfoilSurrogateModelGroup2(csdl.CustomExplicitOperation):
    def initialize(self):
    ...
    def compute(self, inputs, outputs):
        ...
        if not rotor['custom_polar']:
            ...
            outputs['Cl_2'] = Cl.reshape(shape[0], shape[1], shape[2])
            outputs['Cd_2'] = Cd.reshape(shape[0], shape[1], shape[2])
    ...
    def compute_derivatives(self, inputs, derivatives):
        ...
        if not rotor['custom_polar']:
            ...
            derivatives['Cl_2', 'alpha_distribution'] = dCl_daoa
            derivatives['Cd_2', 'alpha_distribution'] = dCd_daoa
