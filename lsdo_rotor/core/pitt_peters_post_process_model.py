...
class PittPetersPostProcessModel(Model):
    ...
    def define(self):
        ...
        C_T_2 = T / rotor['density'] / (csdl.sum(n,axes=(1,2))/shape[1]/shape[2])**2 / (2 * csdl.sum(rotor_radius,axes=(1,2))/shape[1]/shape[2])**4
        ...
        self.add_objective('total_torque_all_rotors')
        self.add_constraint('total_thrust_all_rotors', equals = 1000)
