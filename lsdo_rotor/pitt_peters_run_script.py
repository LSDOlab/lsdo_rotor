...
class RunModel(Model):
    def define(self):
        ...
        self.create_input(name='rotor_radius', shape=(1, ), units='m', val=0.8)
...
# print(t2-t1)
# sim.prob.check_partials(compact_print=True, form='central', step=1e-5)
print(sim['T'])
print(sim['total_torque'])
# sim.prob.check_totals(form='central',step=1e-6)
...
# sim.prob.driver.opt_settings['Major iterations limit'] = 500
# sim.prob.driver.opt_settings['Major optimality tolerance'] = 2.e-5

# sim.prob.run_driver()
# sim.prob.check_totals(of='_lambda', wrt='density')
# print(sim['total_thrust'])
# print(sim['total_torque'])
# print(sim['twist_profile'])
# print(sim['chord_profile'])
# print(sim['_ux'])

# import matplotlib.pyplot as plt
# plt.plot(sim['_radius'][0,:,0].flatten(),sim['twist_profile'].flatten()*180/np.pi)
# plt.figure()
# plt.plot(sim['_radius'][0,:,0].flatten(),sim['chord_profile'].flatten())
# plt.show()
# exit()
